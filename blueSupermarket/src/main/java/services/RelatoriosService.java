...
public class RelatoriosService {
    ...
    public List<Relatorio> listaVendaPeriodo(String nome, String dataInic, String dataFinal, String cpf){
        List<Relatorio> relatoriosPorData = new ArrayList<>();
        try {
            relatoriosPorData.addAll(new RelatoriosDao().listVendaPorData(nome, dataInic, dataFinal, cpf));
            if(relatoriosPorData!=null){
